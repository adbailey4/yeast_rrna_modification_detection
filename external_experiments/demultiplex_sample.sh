...
do
  ...
  python3.7 /home/ubuntu/src/deeplexicon/deeplexicon.py -p "$temp_dir/$fast5/" -f multi -m /home/ubuntu/src/deeplexicon/experiments/resnet20-final.h5 > $temp_dir/dmux_output/$fast5.tsv 2> /dev/null
